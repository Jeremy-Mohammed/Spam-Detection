...
void generateComputerMove(string board[][SIZE], int r, int c){
        bool validMove = false;
		int row; int col; int i = 0;
        while (!validMove) {
			if (i==0){
				row = 1;
				col = 1;
				...
				if ((board[0][0] == "O" && board[0][1] == "O") || (board[0][0] == "X" && board[0][1] == "X")
					|| (board[2][2] == "O" && board[2][1] == "O") || (board[2][2] == "X" && board[2][1] == "X")
					|| (board[2][0] == "O" && board[1][1] == "O") || (board[2][0] == "X" && board[1][1] == "X")
					&& (board[0][2] != "X") && (board[0][2] != "O")){
					row = 0;
					col = 2;
				}
				else if ((board[0][1] == "O" && board[0][2] == "O") || (board[0][1] == "X" && board[0][2] == "X")
					|| (board[1][0] == "O" && board[2][0] == "O") || (board[1][0] == "X" && board[2][0] == "X")
					|| (board[2][2] == "O" && board[1][1] == "O") || (board[2][2] == "X" && board[1][1] == "X")
					&& (board[0][0] != "X") && (board[0][0] != "O")){
					row = 0;
					col = 0;
				}
				else if ((board[0][0] == "O" && board[1][0] == "O") || (board[0][0] == "X" && board[1][0] == "X")
					|| (board[1][1] == "O" && board[0][2] == "O") || (board[1][1] == "X" && board[0][2] == "X")
					|| (board[2][2] == "O" && board[2][1] == "O") || (board[2][2] == "X" && board[2][1] == "X")
					&& (board[2][0] != "X") && (board[2][0] != "O")){
					row = 2;
					col = 0;
				}
				else if ((board[0][2] == "O" && board[1][2] == "O") || (board[0][2] == "X" && board[1][2] == "X")
					|| (board[1][1] == "O" && board[0][0] == "O") || (board[1][1] == "X" && board[0][0] == "X")
					|| (board[2][0] == "O" && board[2][1] == "O") || (board[2][0] == "X" && board[2][1] == "X")
					&& (board[2][2] != "X") && (board[2][2] != "O")){
					row = 2;
					col = 2;
				}
				else if ((board[0][0] == "O" && board[0][2] == "O") || (board[0][0] == "X" && board[0][2] == "X")
					|| (board[2][1] == "O" && board[1][1] == "O") || (board[2][1] == "X" && board[1][1] == "X")
					&& (board[0][1] != "X") && (board[0][1] != "O")){
					row = 0;
					col = 1;
				}
				else if ((board[0][1] == "O" && board[1][1] == "O") || (board[0][1] == "X" && board[1][1] == "X")
					|| (board[2][0] == "O" && board[2][2] == "O") || (board[2][1] == "X" && board[2][2] == "X")
					&& (board[2][1] != "X") && (board[2][1] != "O")){
					row = 2;
					col = 1;
				}
				else if ((board[0][0] == "O" && board[2][0] == "O") || (board[0][0] == "X" && board[2][0] == "X")
					|| (board[1][2] == "O" && board[1][1] == "O") || (board[1][2] == "X" && board[1][1] == "X")
					&& (board[1][0] != "X") && (board[1][0] != "O")){
					row = 1;
					col = 0;
				}
				else if ((board[2][2] == "O" && board[0][2] == "O") || (board[2][2] == "X" && board[0][2] == "X")
					|| (board[1][0] == "O" && board[1][1] == "O") || (board[1][0] == "X" && board[1][1] == "X")
